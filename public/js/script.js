...
function searchPrice(){
    var price_list = [
        // 정품액정 재생액정 OLED액정 인셀액정 표준용량 대용량배터리 하우징 독커넥터 탭틱엔진 전면카 후면카 수화부 하단스피커 볼륨케이블 전원케이블 무선충전 듀얼심개조
        [33700, "품절", "해당없음", 20300, 26400, 32800, 20000, 10600, 7700, 7000, 8000, 5600, 7000, 7000, "해당없음", "해당없음", "해당없음"], //아이폰 SE1
        [37600, 31200, "해당없음", 30200, 17500, 20500, 55000, 17000, 22000, 16000, 55000, 7200, 9900, 9700, "해당없음", 11000, "해당없음"], //아이폰 SE2
        [37600, 31200, "해당없음", 30200, 27000, "품절", 55000, 17000, 22000, 16000, 55000, 7200, 9900, 9700, "해당없음", 11000, "해당없음"], //아이폰 SE3
        [33700, "품절", "해당없음", 20300, 26400, 32800, 20000, 10600, 7700, 7000, 8000, 5600, 7000, 7000, "해당없음", "해당없음", "해당없음"], //아이폰 5
        [33700, "품절", "해당없음", 20300, 26400, 32800, 20000, 10600, 7700, 7000, 8000, 5600, 7000, 7000, "해당없음", "해당없음", "해당없음"], //아이폰 5C
        [33700, "품절", "해당없음", 20300, 26400, 32800, 20000, 10600, 7700, 7000, 8000, 5600, 7000, 7000, "해당없음", "해당없음", "해당없음"], //아이폰 5S
        [34100, 24000, "해당없음", 21300, "품절", 19000, 25000, 10600, 8200, 7000, 8700, 5600, 8200, 9000, 9000, "해당없음", "해당없음"], //아이폰 6
        [40600, 39800, "해당없음", 24000, "품절", 20500, 25000, 10600, 8200, 9000, 15000, 5600, 8200, 9000, 9000, "해당없음", "해당없음"], //아이폰 6+
        [37600, 26400, "해당없음", 22700, 16000, 19000, 25000, 10600, 8200, 9000, 15000, 5600, 8700, 9000, "해당없음", "해당없음", "해당없음"], //아이폰 6S
        [40600, 39800, "해당없음", 24000, "품절", 20500, 25000, 10600, 8200, 9000, 12000, 5600, 8200, 9000, 9000, "해당없음", "해당없음"], //아이폰 6S+
        [37600, 30000, "해당없음", 28900, 16500, 19500, 35000, 12200, 12800, 15000, 30000, 6200, 9400, 9000, "해당없음", "해당없음", "해당없음"], //아이폰 7
        [42300, 40800, "해당없음", 28900, 18000, 21000, 40000, 12400, 12800, 17500, 60000, 6200, 10600, 9000, "해당없음", "해당없음", "해당없음"], //아이폰 7+
        [37600, 31200, "해당없음", 30200, 17500, 20500, 50000, 17000, 22000, 16000, 55000, 7200, 9900, 9700, "해당없음", 11000, "해당없음"], //아이폰 8
        [57400, 40800, "해당없음", 36200, 18500, 21500, 55000, 17000, 30600, 20000, 67000, 7200, 10600, 9700, "해당없음", 11000, "해당없음"], //아이폰 8+
        ...
        [278800, "품절", 156000, 127000, 33500, "품절", 80000, "품절", 25200, "품절", "품절", 48600, "품절", "해당없음", "해당없음", 33800, 45000], //아이폰 12
        [278800, "품절", 156000, 127000, 33500, "품절", 80000, "품절", 25200, "품절", "품절", 48600, "품절", "해당없음", "해당없음", 33800, 45000], //아이폰 12Pro
        ["품절", "품절", 264000, 175200, "품절", "품절", 80000, "품절", 25200, "품절", "품절", 48600, "품절", "해당없음", "해당없음", 33800, 65000], //아이폰 12ProM
        ["품절", "품절", 198000, 192000, "품절", "품절", 90000, "품절", "품절", "품절", "품절", "품절", "품절", "해당없음", "해당없음", "품절", "품절"], //아이폰 13mini
        ["품절", 252000, 198000, 192000, "품절", "품절", 90000, "품절", "품절", "품절", "품절", "품절", "품절", "해당없음", "해당없음", "품절", 45000], //아이폰 13
        ["품절", "품절", "품절", "품절", "품절", "품절", 90000, "품절", "품절", "품절", "품절", "품절", "품절", "해당없음", "해당없음", "품절", 45000], //아이폰 13Pro
        ["품절", "품절", "품절", "품절", "품절", "품절", 90000, "품절", "품절", "품절", "품절", "품절", "품절", "해당없음", "해당없음", "품절", 65000] //아이폰 13ProM
    ]
